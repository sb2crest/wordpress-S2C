...
$classes[] = sprintf( 'projects-filter-%s', kiraz_option( 'projects__filterableAlign' ) );
/**
 * Ignore fetching project terms when archive filter is
 * disabled
 */
if ( kiraz_option( 'projects__filterable' ) == 'on' ):
	$terms = array();
	$filter_type = kiraz_option( 'projects__filterableType' );
