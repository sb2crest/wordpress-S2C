 ...
 * @return  void
 */
function kiraz_define_style( $selector, array $attributes ) {
...
function kiraz_scheme_styles() {
	global $wp_filesystem;
	
	if ( kiraz_initialize_filesystem_api() ) {
		$content = $wp_filesystem->get_contents( Kiraz_PATH . 'assets/less/_color.less' );
		$colors  = kiraz_option( 'global__typography__scheme' );
 ...
 * @return  array
 */
function kiraz_typography_styles( array $options ) {
	$styles = array();

	if ( isset( $options['family'] ) && $family = kiraz_parse_font( $options['family'] ) ) {
...
function kiraz_parse_font( $font, $enqueue = true ) {
 ...
 * @return  array
 */
function kiraz_background_styles( $options ) {
	$styles = array();
 ...
 * @return  array
 */
function kiraz_border_styles( $options ) {
 ...
 * @return  string
 */
function kiraz_color_to_rgba( $color, $alpha ) {
